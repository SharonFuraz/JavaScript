...
"<div>Primero lavar bien las papas,hervirlas con cáscara ya que al cocerlas con cáscara evitamos que absorban agua en exceso.</div><div> Hacemos un corte horizontal por todo el contorno de la papa,las llevamos a una olla con agua.</div><div> Cocinar hasta que al pincharlas se caigan.Las retiramos y las dejamos enfriar sólo para no quemarnos.</div><div> Con el corte que hicimos, la cáscara tiene que salir muy fácil en dos partes.</div><div>Pisamos las papas todavía en caliente como pure, agregamos sal, pimienta y mezclamos bien.</div><div>Agregamos el huevo batido y la harina. No le vamos a agregar toda la harina de una, nos vamos a guardar un poco para ver cómo viene.</div><div> Las cantidades son más bien proporcionales, puede ser que la papa haya absorbido más agua o que el huevo sea más chico, así que vamos a agregar la harina de a poco.</div><div>Unir con la mano hasta que se pueda pasar hasta la mesada y terminar de integrar.</div> <div>Si en este paso ven que hace falta más harina, tenemos el resto para agregar.</div><div> No es necesario amar mucho, la idea es llegar a una masa unida y uniforme sin tocarla mucho.</div><div>Cortar tiras de masa y hacer chorricitos o rollitos, y cortar trocitos de unos 2 o 3 cm de ancho, pueden enharinar el cuchillo para que sea más fácil.Ahora viene la magia, vamos a pasarlos por la herramienta para darle forma a los ñoquis de papa de arriba hacia abajo.También pueden usar un tenedor enharinado que también les deja una forma similar.</div><div> Colocarlos en una placa enharinada sin que se toquen para que no se pegoteen.</div><div>Para la cocción, llevar de a tandas a una olla con agua hirviendo con sal.</div><div> Van a ver que se caen al fondo. Cuando suben, los dejan 1 minuto y ya están listos</div>",1000,
...
"<div>En un bol mezclar la harina de garbanzos junto con la sal y la pimienta.</div><div> Ir agregando el agua de a poco, sin que se armen grumos.</div><div> Luego, agregar el aceite de oliva y usar un batidor de mano para incorporar todo muy bien.</div><div> La mezcla debe quedar bien uniforme.</div><div> Llevar a refrigerar por un día como mínimo.</div><div> Una vez transcurrido el tiempo colocar en una pizzera previamente calentada con aceite en un horno bien alto (a 220°).</div><div>Cocinar hasta que la fainá esté dorada.</div>",500,
...
for (let i = 0; i < recetas.length; i++) {
    ...
    <p class="modal__contenido2">Ingredientes:</p>
    ...
    <p class="modal__contenido2">Preparación:</p>
